    ...
    try {
      ...
      const signalData = new Signal({
        ...
        analysis: {
          ...
          strikeSelection: analysis.strikeSelection || null,
          ...
          atr: analysis.atr || 0,
          marketContext: analysis.marketContext || null,
          levels: analysis.levels || [],
          camarilla: analysis.camarilla || null,
          roundNumbers: analysis.roundNumbers || null,
          confluence: analysis.confluence || null,
          liquidity: analysis.liquidity || null,
          marketPhase: analysis.marketPhase || null,
          events: analysis.events || [],
          passiveMetrics: analysis.passiveMetrics || null,
          previousDay: analysis.previousDay || null,
        },
        scoring: scoring || {},
        status: "GENERATED",
      });
    ...
    try {
      const tradeData = new Trade({
        ...
        metadata: {
          ...
          passive: trade.passiveMetrics || null,
        },
      });
